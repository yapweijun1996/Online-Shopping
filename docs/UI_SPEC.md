...
**Status: design reference, not implemented.** The images are conceptual previews with fictional example orders. Layout and behavior below are the implementation target; image text and numbers are not live data or a final currency decision.
