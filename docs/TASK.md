...
| API-04 | P0 / In progress | API-03, DEC-02 | A server +60/+65 phone normalization helper and malformed-input tests pass. Integrate it with buyer/recipient field errors, destination validation, consent, assignments, quantities and server totals/snapshots without GST; AC-06–08 API tests remain. |
