...
export const messages = {
  en: {
    ...
    imageHelp: 'PNG, JPEG or WebP, up to 512 KB.', productSaved: 'Product saved.', productError: 'Could not save product. Check the fields and try again.', duplicateSku: 'This SKU is already in use. Choose another SKU.',
  ...
  ms: {
    ...
    imageHelp: 'PNG, JPEG atau WebP, sehingga 512 KB.', productSaved: 'Produk disimpan.', productError: 'Produk tidak dapat disimpan. Semak medan dan cuba lagi.', duplicateSku: 'SKU ini sudah digunakan. Pilih SKU lain.',
  ...
  'zh-Hans': {
    ...
    imageHelp: 'PNG、JPEG 或 WebP，最大 512 KB。', productSaved: '商品已保存。', productError: '无法保存商品，请检查字段后重试。', duplicateSku: '此 SKU 已被使用，请换一个。',
  ...
  vi: {
    ...
    imageHelp: 'PNG, JPEG hoặc WebP, tối đa 512 KB.', productSaved: 'Đã lưu sản phẩm.', productError: 'Không thể lưu sản phẩm. Kiểm tra thông tin và thử lại.', duplicateSku: 'SKU này đã được dùng. Chọn SKU khác.',
  ...
  th: {
    ...
    imageHelp: 'PNG, JPEG หรือ WebP ไม่เกิน 512 KB', productSaved: 'บันทึกสินค้าแล้ว', productError: 'บันทึกสินค้าไม่ได้ ตรวจสอบข้อมูลแล้วลองอีกครั้ง', duplicateSku: 'SKU นี้ถูกใช้แล้ว เลือก SKU อื่น',
  ...
  ja: {
    ...
    imageHelp: 'PNG、JPEG、WebP、最大512 KB。', productSaved: '商品を保存しました。', productError: '商品を保存できません。入力内容を確認してください。', duplicateSku: 'この SKU は使用済みです。別の SKU を選んでください。',
  ...
  ko: {
    ...
    imageHelp: 'PNG, JPEG 또는 WebP, 최대 512 KB.', productSaved: '상품을 저장했습니다.', productError: '상품을 저장할 수 없습니다. 입력값을 확인하고 다시 시도하세요.', duplicateSku: '이미 사용 중인 SKU입니다. 다른 SKU를 선택하세요.',
